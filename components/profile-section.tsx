    ...
    <div className="px-4 py-6">
      ...
      <div className="space-y-4">
        <Link href="/profile/personal-data">
          <div className="flex items-center justify-between p-3 bg-card rounded-xl border border-border hover:border-primary/30 hover:bg-surface-tint transition-all shadow-sm">
        ...
        <button
          ...
          className="w-full flex items-center justify-between p-3 bg-card rounded-xl border border-border hover:border-red-500/30 hover:bg-red-50/50 transition-all shadow-sm"
        >
          <div className="flex items-center gap-3">
